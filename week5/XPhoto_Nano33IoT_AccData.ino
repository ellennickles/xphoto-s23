/*
  ...
  Modified in Feb 2022 by Ellen Nickles
...
void loop() {
  ...
  if (x > 0.1) {
    ...
    Serial.print("X axis - Tilting up: ");
  ...
  if (x < -0.1) {
    ...
    Serial.print("X axis - Tilting down: ");
    Serial.print(degreesX);
    Serial.println("  degrees");
  }
  if (y > 0.1) {
    ...
    Serial.print("Y Axis - Tilting left: ");
  ...
  if (y < -0.1) {
    ...
    Serial.print("Y Axis - Tilting right: ");
    Serial.print(degreesY);
    Serial.println("  degrees");
  }
